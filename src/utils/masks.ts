...
interface IMasks {
  ...
  cpfHidden(value: string): string;
  cnpj(value: string): string;
  cnpjHidden(value: string): string;
  phone(value: string): string;
  hiddenDocument(value: string): string;
  ...
  reduceText(value: string, length: number): string;
...
const Masks: IMasks = {
  ...
  cpfHidden(value: string): string {
    ...
    const finalDocument = document.substring(3, document.length - 2);
  ...
  hiddenDocument(value: string): string {
    ...
    if (value.length === 14) {
      return Masks.cnpjHidden(value);
    }

    return Masks.cpfHidden(value);
  },
  ...
  reduceText(value: string, length: number = 20): string {
